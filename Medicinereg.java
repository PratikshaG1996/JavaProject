...
public class Medicinereg extends JFrame implements ActionListener
{
...
PreparedStatement pst=con.prepareStatement("select max(medicine_id)+1 from medicine");
...
{
JOptionPane.showMessageDialog(Medicinereg.this,"Error !"+ex);
}
...
l5=new JLabel("Medicine Register");
...
PreparedStatement pst=con.prepareStatement("insert into medicine (medicine_id,medicine_name,medicine_description,medicine_stock,supplier_id) values(?,?,?,?,?)");
...
if(n>0)
JOptionPane.showMessageDialog(Medicinereg.this,"Record Inserted Successfully !");
else
JOptionPane.showMessageDialog(Medicinereg.this,"Record Not Inserted Successfully !");
}
catch(Exception ex)
{
JOptionPane.showMessageDialog(Medicinereg.this,"Error !"+ex);
