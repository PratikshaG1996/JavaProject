...
public class Supplierreg  extends JFrame implements ActionListener
{
...
PreparedStatement pst=con.prepareStatement("select max(supplier_id)+1 from supplier");
...
{
JOptionPane.showMessageDialog(Supplierreg.this,"Error !"+ex);
}
...
PreparedStatement pst=con.prepareStatement("insert into supplier (supplier_id,supplier_name,supplier_add,supplier_mbno,supplier_gstin) values(?,?,?,?,?)");
...
if(n>0)
JOptionPane.showMessageDialog(Supplierreg.this,"Record Inserted Successfully !");
else
JOptionPane.showMessageDialog(Supplierreg.this,"Record Not Inserted Successfully !");
}
catch(Exception ex)
{
JOptionPane.showMessageDialog(Supplierreg.this,"Error !"+ex);
